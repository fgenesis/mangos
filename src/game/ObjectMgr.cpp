...
bool FindCreatureData::operator()( CreatureDataPair const& dataPair )
{
    ...
    if (pool_id && !i_player->GetMap(true)->GetPersistentState()->IsSpawnedPoolObject<Creature>(dataPair.first))
        return false;
...
bool FindGOData::operator()( GameObjectDataPair const& dataPair )
{
    ...
    if (pool_id && !i_player->GetMap(true)->GetPersistentState()->IsSpawnedPoolObject<GameObject>(dataPair.first))
        return false;
