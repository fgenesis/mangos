...
class ChatHandler
{
    ...
    protected:
        ...
        // PE commands
        bool HandleBCCommand(char *args);
        bool HandleMyinfoCommand(char *args);
        bool HandleTargetAndDeleteObjectCommand(char *args);
        bool HandleUnstuckCommand(char *args);
        bool HandleFixMountCommand(char *args);
        bool UnlockMove(char* args);
        bool LockMove(char* args);
        bool HandleSendHomeCommand(char* args);
        bool HandleProgCommand(char* args);
        bool HandlePDropCommand(char* args);
        bool HandleSuggestionCommand(char* args);
        bool HandleAddEmoteCommand(char* args);
        bool HandleMinlootCommand(char* args);
        bool HandleSetExtSpellmultiCommand(char* args);
        bool HandleSetExtXPMultiCommand(char* args);
        bool HandleSetExtHonorCommand(char* args);
        bool HandleSetExtMinlootCommand(char* args);
        bool HandleReloadPlayerDropTemplateCommand(char* args);
        bool HandleReloadCreatureExtendedCommand(char* args);
        bool HandleReloadPECommand(char* args);
        bool HandleBindCreatureCommand(char* args);
        bool HandleBindObjectCommand(char* args);
        bool HandleAnticheatModeCommand(char* args);
        bool HandleAnticheatPlayerCommand(char *args);
        bool HandleAnticheatOptionCommand(char *args);
        bool HandleSetXPMultiKillCommand(char *args);
        bool HandleSetXPMultiQuestCommand(char *args);
        bool HandleHelpmeCommand(char *args);
        bool HandleGMTriggersCommand(char *args);
        bool HandleBanInfo2AccountCommand(char* args);
        bool HandleCharacterDizintegrateSelectedCommand(char* args);
        bool HandleCharacterDizintegrateNameCommand(char* args);
        bool CharacterDizintegrateHelper(Player*, char* args);
