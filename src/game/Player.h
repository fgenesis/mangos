...
struct DuelInfo
{
    DuelInfo() : initiator(NULL), opponent(NULL), startTimer(0), startTime(0), outOfBound(0), ended(false) {}
...
enum AtLoginFlags
{
    ...
    AT_LOGIN_LOW_HP = 0x2000 // FG: required for almost-dead state when logging out in combat and logging in back
};
...
enum PlayerLoginQueryIndex
{
    ...
    PLAYER_LOGIN_QUERY_LOADMYINFO = 27, // FG: custom queries
    PLAYER_LOGIN_QUERY_LOADEXTENDED = 28,
...
class MANGOS_DLL_SPEC Player : public Unit
{
    ...
    public:
        ...
        bool CanTitanGrip() const; // FG: my version (see func body in Player.cpp)
        // bool CanTitanGrip() const { return m_canTitanGrip; } // FG: <-- original version
