...
{                                                                            /*thread-safe*/
    ...
    /*0x476*/ { "CMSG_REQUEST_VEHICLE_EXIT",                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::HandleRequestVehicleExit        },
    /*0x477*/ { "CMSG_REQUEST_VEHICLE_PREV_SEAT",               STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::HandleRequestVehiclePrevSeat    },
    /*0x478*/ { "CMSG_REQUEST_VEHICLE_NEXT_SEAT",               STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::HandleRequestVehicleNextSeat    },
    /*0x479*/ { "CMSG_REQUEST_VEHICLE_SWITCH_SEAT",             STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::HandleRequestVehicleSwitchSeat  },
    ...
    /*0x49B*/ { "CMSG_CHANGE_SEATS_ON_CONTROLLED_VEHICLE",      STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::HandleChangeSeatsOnControlledVehicle},
    ...
    /*0x4A8*/ { "CMSG_PLAYER_VEHICLE_ENTER",                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::HandleEnterPlayerVehicle        },
    /*0x4A9*/ { "CMSG_EJECT_PASSENGER",                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::HandleEjectPasenger             },
