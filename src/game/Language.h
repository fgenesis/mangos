...
//                                      = 783, not used
    ...
    LANG_BROADCAST_MSG = 11100,
    LANG_AUTOBROADCAST = 11101,
    LANG_MAILBOX_FULL = 11102,
    LANG_GM_TRIGGERS_ON = 11103,
    LANG_GM_TRIGGERS_OFF = 11104,
    LANG_ENTERED_TRIGGER = 11105,
    LANG_GM_HAX_ON = 11106,
    LANG_GM_HAX_OFF = 11107,
    LANG_GM_HAX_MESSAGE = 11108,
    LANG_YOUR_GLOBAL_CHANNELS_CHAT_DISABLED = 11109,
    LANG_ARENA_SAME_IP_NO_REWARD = 11110,
    LANG_YOUR_GLOBAL_CHANNELS_CHAT_ENABLED = 11111,
    LANG_YOU_DISABLE_CHANNEL_CHAT = 11112,
    LANG_YOU_ENABLE_CHANNEL_CHAT = 11113,
    LANG_WAIT_BEFORE_SPEAKING_IN_CHANNEL = 11114,
    LANG_BADPOINTS_REACHED = 11115,
    LANG_BADPOINTS_INFO = 11116,
    LANG_NO_RECORD_IN_DB = 11117,
    LANG_NO_REASON_GIVEN = 11118,
    LANG_PUNISH_RESULT = 11119,
    LANG_BADPOINTS_PINFO = 11120
};
#endif
