...
enum WorldConfigs
{
    ...
    CONFIG_ALLOW_CITY_DUELING,
    CONFIG_DIPLOMACY_GROUP_MODE_ENABLE,
    CONFIG_DIPLOMACY_GROUP_MODE_LEVELMULTI,
    CONFIG_DIPLOMACY_GROUP_MODE_MINLEVEL,
    CONFIG_DIPLOMACY_GROUP_MODE_MAXDIST,
    
    CONFIG_ACH_MISTIMING_DELTA,
    CONFIG_ACH_NOTIFY_INTERVAL,
    CONFIG_ACH_NOTIFY_IMPACT_1,
    CONFIG_ACH_NOTIFY_IMPACT_2,
    CONFIG_ACH_NOTIFY_IMPACT_3,
    CONFIG_ACH_IMPACT_MISTIMING_FLAT,
    CONFIG_ACH_IMPACT_MISTIMING_MULTI,
    CONFIG_ACH_IMPACT_GRAVITY,
    CONFIG_ACH_IMPACT_SPEED_FLAT,
    CONFIG_ACH_IMPACT_SPEED_MULTI,
    CONFIG_ACH_IMPACT_MULTIJUMP,
    CONFIG_ACH_IMPACT_MOUNTAIN,
    CONFIG_ACH_IMPACT_FLY,
    CONFIG_ACH_IMPACT_WATERWALK,
...
enum Rates
{
    ...
    MULTI_SPELL_BASE_HEALING_BONUS,
