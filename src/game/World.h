...
enum WorldTimers
{
    ...
    WUPDATE_ONLINESTATS = 9,
    WUPDATE_ANTICHEAT_ACC_INFO = 10,
    WUPDATE_VPLAYERS    = 11,
    WUPDATE_NETMON      = 12,
    WUPDATE_QUERYCOUNTER = 13,
...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_MAX_MUTETIME,
    CONFIG_UINT32_MAX_CHANNEL_MUTETIME,
    CONFIG_UINT32_ACH_MISTIMING_DELTA,
    CONFIG_UINT32_ACH_NOTIFY_INTERVAL,
    CONFIG_UINT32_ACH_NOTIFY_IMPACT_1,
    CONFIG_UINT32_ACH_NOTIFY_IMPACT_2,
    CONFIG_UINT32_ACH_NOTIFY_IMPACT_3,
    CONFIG_UINT32_ACH_IMPACT_MISTIMING_FLAT,
    CONFIG_UINT32_ACH_IMPACT_MISTIMING_MULTI,
    CONFIG_UINT32_ACH_IMPACT_GRAVITY,
    CONFIG_UINT32_ACH_IMPACT_SPEED_FLAT,
    CONFIG_UINT32_ACH_IMPACT_SPEED_MULTI,
    CONFIG_UINT32_ACH_IMPACT_MULTIJUMP,
    CONFIG_UINT32_ACH_IMPACT_MOUNTAIN,
    CONFIG_UINT32_ACH_IMPACT_FLY,
    CONFIG_UINT32_ACH_IMPACT_WATERWALK,
    CONFIG_UINT32_ACH_IMPACT_TELEPORT_TO_PLANE_FLAT,
    CONFIG_UINT32_ACH_IMPACT_TELEPORT_TO_PLANE_MULTI,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_ALLOW_CITY_DUELING,
    CONFIG_BOOL_LIMIT_GM_ACCOUNTS,
    CONFIG_BOOL_PLAINTEXT_PASSWORDS,
    CONFIG_BOOL_NETMON_RECORD_OUTGOING,
