    ...
    switch(dummySpell->SpellFamilyName)
    {
            ...
            switch(dummySpell->Id)
            {
                ...
                case 55677:
                {
                    ...
                    if (target->GetTypeId() == TYPEID_PLAYER)
                        ...
                        basepoints[0] = int32(caster->GetPercentOfMaxHP(float(triggerAmount)));
        ...
        case SPELLFAMILY_PALADIN:
        {
            ...
            switch(dummySpell->Id)
            {
                ...
                case 58597:
                {
                    if(pVictim) // FG: this was added at an earlier point
                ...
                case 70755:
                {
                    // FG: TODO: This check is not needed in 4.x and must be removed
        ...
        case SPELLFAMILY_DEATHKNIGHT:
        {
            ...
            if (dummySpell->Id == 49194)
            {
                basepoints[0] = triggerAmount * damage / 1000; // FG: 1000 instead of 100 as suggested by TGM
                triggered_spell_id = 50536;
                break;
            }
            // Vendetta
