...
{
{"?? ?????? ??????? ? ?????????? ??????????????? ????????",GOSSIP_ACTION_INFO_DEF+1,false,TYPE_GRAND_CHAMPIONS}, //
{"?? ?????? ??????? ? ????????? ??????????? ?????????",GOSSIP_ACTION_INFO_DEF+2,false,TYPE_ARGENT_CHALLENGE},  //
{"?? ?????? ??????? ? ?????? ????????",GOSSIP_ACTION_INFO_DEF+3,false,TYPE_BLACK_KNIGHT}, //
{"?? ???? ???? ??????. ?? ??????? ????? ???????.",GOSSIP_ACTION_INFO_DEF+4,true,TYPE_BLACK_KNIGHT}, //
};
